    ...
    */
    ...
    this.add = function(item){
        ...
        */
        ...
        addEvent(item,"transitionend",function(e){self.endTransit(e)})
        addEvent(item,"webkitTransitionEnd",function(e){self.endTransit(e)})
    }
    this.display = function(){
    ...
    this.touchHandle = function(e,type){
        ...
        if(type == "end"){
            ...
            var forward = sliderCoord.right > currentCoord.right
            var backward = currentCoord.left > sliderCoord.left
            if((sliderCoord.right - currentCoord.right) >= nextThreshold){
                //foward
                console.log("foward",sliderCoord.right,currentCoord.right)
                this.move(true)
            }
            else if((currentCoord.left - sliderCoord.left) >= nextThreshold){
                //backward
                console.log("backward",sliderCoord.left,currentCoord.left)
                this.move(false)
            }
            else{
                var recoilDir
                ...
                else{console.log("wtf"); return}
                console.log(recoilDir)
                this.touchRecoil(recoilDir)
            }
            console.log("foward : ",forward,"backward : ",backward)
            return
        }
